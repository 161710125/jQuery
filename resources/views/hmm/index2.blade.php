               ...
               <form method="post" id="student_form">
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" name="nilai" id="nilai" class="form-control" placeholder="nilai pertama" />
                     </div>
                     <div class="form-group">
                        <label>Nilai Dua</label>
                        <input type="number" name="nilai1" id="nilai1" class="form-control" placeholder="nilai kedua" />
                     </div>
                  </div>
